...
import authRouter from './src/routes/authorisation.route';
import contactRoute from './src/routes/message.route';
...
app.get('/', (req: Request, res: Response) => {
    res.send(
        '<h1>PORTIFOLIO BACKEND API</h1><a href="/api-docs">Documentation</a>',
    );
});
...
app.use('/api/v1/message', contactRoute);
